...
public class GraphWay {
  ...
  private boolean isWallPath; 
  private boolean isWalkPath;
  ...
  public void setWallPath(boolean status){
    this.isWallPath = status; 
  }  
  
  public void setWalkPath(boolean status){
    this.isWalkPath = status; 
  }
